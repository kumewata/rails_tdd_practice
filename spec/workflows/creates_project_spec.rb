...
RSpec.describe CreatesProject do
  ...
  describe "task string parsing" do
    ...
    describe "with multiple tasks" do
      ...
      specify { expect(tasks).to match([an_object_having_attributes(title: "Start Things", size: 3), an_object_having_attributes(title: "End Things", size: 2)]) }
    end
    ...
    describe "attaches tasks to the project" do
      ...
      specify { expect(creator.project).to_not be_a_new_record }
    end
  end
end
